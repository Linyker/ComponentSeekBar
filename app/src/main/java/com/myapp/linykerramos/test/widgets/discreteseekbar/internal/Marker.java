package com.myapp.linykerramos.test.widgets.discreteseekbar.internal;/*
...
public class Marker extends ViewGroup implements MarkerDrawable.MarkerAnimationListener {
    ...
    public Marker(Context context, AttributeSet attrs, int defStyleAttr, String maxValue, int thumbSize, int separation) {
        ...
        int textAppearanceId = a.getResourceId(R.styleable.ComponentSeekBar_dsb_indicatorTextAppearance,
        ...
        ColorStateList color = a.getColorStateList(R.styleable.ComponentSeekBar_dsb_indicatorColor);
        ...
        float elevation = a.getDimension(R.styleable.ComponentSeekBar_dsb_indicatorElevation, ELEVATION_DP * displayMetrics.density);
